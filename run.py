...
class MyApp(App):
    def build(self):
        ...
        self.sound = SoundLoader.load("assets/apito.mp3")
        self.sound.volume = 0.5
        self.sound.play()

        self.sound = SoundLoader.load("assets/som.mp3")
        ...
        background_image = Image(source='assets/fundomodificado.png', allow_stretch=True, keep_ratio=False, size_hint=(1, 1), pos_hint={'center_x': 0.5, 'center_y': 0.5})
        ...
        self.ball_image = Image(source='assets/bola.png', size_hint=(None, None), size=(100, 100), pos=(63 - 47, 212 - 52))
        layout.add_widget(self.ball_image)


        self.button1 = Button(background_normal='assets/saque.png', background_down='assets/Saque (1).png.png', size_hint=(0.2,0.118), pos_hint={'right': 0.992, 'top': 0.769})
        self.button2 = Button(background_normal='assets/ataque.png', background_down='assets/ataque(1).png', size_hint=(0.2, 0.120), pos_hint={'right': 0.99, 'top': 0.63})
        self.button3 = Button(background_normal='assets/rotação.png', background_down='assets/rotação(1).png', size_hint=(0.2, 0.118), pos_hint={'right': 0.99, 'top': 0.48})
        ...
        self.rotation_label = Label(text='Rodizio: 0',font_name='Montserrat-Bold.ttf', font_size=35, size_hint=(None, None), size=(200, 50), pos=(6, -2))
        layout.add_widget(self.rotation_label)
    ...
    def on_serve_button_press(self, instance):
        ...
        self.sound = SoundLoader.load("assets/saque.mp3")
        self.sound.volume = 0.5
        self.sound.play()
        ...
        serve_paths = {
            1: {#Ajeitado
                ...
                'assets/bola.png': {'coordinates': [(18,157),(397, 274), (306, 267)], 'speed': 4},
            ...
            2: {#Ajeitado
                'assets/bola.png': {'coordinates': [(132, 269), (240, 274)], 'speed': 3},
            ...
            3: {#Ajeitado
                'assets/bola.png': {'coordinates': [(434,278),(307, 262)], 'speed': 3.6},
                'timeB/Blibero.png': {'coordinates': [(394, 228)], 'speed': 2},
                'timeA/Aponteiro2.png': {'coordinates': [(109, 186)], 'speed': 2},
            },
            4: {  # Ajeitado
                'assets/bola.png': {'coordinates': [(119, 353), (233, 276)], 'speed': 3.6},
                'timeB/Bponteiro1.png': {'coordinates': [(423, 358)], 'speed': 2},
            },
            5:{
                'assets/bola.png': {'coordinates': [(444, 278), (306, 273)], 'speed': 3.6},
    ...
    def on_attack_button_press(self, instance):
        ...
        self.sound = SoundLoader.load("assets/ataque.mp3")
        self.sound.volume = 0.5
        self.sound.play()
        ...
        attack_paths = {
            1: {#Ajeitado
                'assets/bola.png': {'coordinates': [(286, 174), (174, 288)], 'speed': 2},
            ...
            2: {#Ajeitado
                'assets/bola.png': {'coordinates': [(259, 392), (348,402)], 'speed': 2},
            ...
            3: {#Ajeitado
                'assets/bola.png': {'coordinates': [(350, 281),(272,276),(398,85)], 'speed': 2},
            ...
            4: {  # Ajeitado
                'assets/bola.png': {'coordinates': [(264, 175), (367,312)], 'speed': 2},
        ...
        5:{
            'assets/bola.png': {'coordinates': [(285, 144), (130, 148)], 'speed': 2},
    ...
    def on_next_rotation_button_press(self, instance):
        ...
        self.sound = SoundLoader.load("assets/apito2.mp3")
        self.sound.volume = 0.5
        self.sound.play()
        
        rotation_paths = {
            1: {#Ajeitado
                'assets/bola.png': {'coordinates': [(254, 439), (514, 443), (515, 390)], 'speed': 3},
                'timeB/Blevantador.png': {'coordinates': [(458, 284)], 'speed': 2},
            ...
            2: {#Ajeitado
                'assets/bola.png': {'coordinates': [(277, 450),(8,440),(21,157)], 'speed': 2},
            ...
            3: {  # Ajeitado
                'assets/bola.png': {'coordinates': [(512, 387)], 'speed': 2},
                'timeA/Acentral.png': {'coordinates': [(133, 267)], 'speed': 2},
                'timeA/Alevantador.png': {'coordinates': [(117, 354)], 'speed': 2},
                'timeA/Alibero.png': {'coordinates': [(210, 362)], 'speed': 2},
                'timeA/Aoposto.png': {'coordinates': [(232, 276)], 'speed': 2},
            ...
            4:{
                'assets/bola.png': {'coordinates': [(295, 440), (13, 437), (21,151)], 'speed': 2},
        ...
        if self.next_rotation_path == 6:
             self.next_rotation_path = 1
        self.rotation_label.text = f'Rodizio: {self.next_rotation_path}'
